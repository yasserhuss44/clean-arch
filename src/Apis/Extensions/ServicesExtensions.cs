...
using School.Application.Services.SystemFeatures;
using System;
...
public static class ServicesExtensions
{
    ...
    //        this IServiceCollection services)
    //    {
    //        var x= services.Scan(scan => scan.FromAssemblyOf<StudentService>().AddClasses(classes => classes.AssignableTo<IScopedService>())
    ...
    //    var types = AppSchool.Domain.CurrentSchool.Domain.GetAssemblies()
    ...
    public static void RegisterGenericRepositoryAndUOW(this IServiceCollection services)
    {
