...
public class InboundCallApiKeyAttribute :
    TypeFilterAttribute
{
    public InboundCallApiKeyAttribute(
        params ApiKeyPrefixes[] prefixes) 
        : base(typeof(InboundCallApiKeyFilter))
        => Arguments = new object[] { prefixes };

    private class InboundCallApiKeyFilter :
        IActionFilter
    {
